...
const trialCommand = new SlashCommandBuilder()
    .setName('trial')
    .setDescription('Sends a trial message in the channel');
...
const commands = [addCommand, setLogChannelCommand, trialCommand];
